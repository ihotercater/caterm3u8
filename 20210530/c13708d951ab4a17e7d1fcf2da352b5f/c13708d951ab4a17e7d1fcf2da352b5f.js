var dcys = {
	...
	'advs': {
		'head': '本插件由『解析地』提供 >>> 官方网站：<a href="//www.jiexi.de/">www.jiexi.de</a> >>> 广告投放 >> 咨询QQ：<a href="http://wpa.qq.com/msgrd?v=3&uin=910657576&site=qq&menu=yes" class="layui-badge layui-bg-red">910657576</a> >>>',
		'tips': '',
		'rows': [{
			'name': '<font color="red">解析地</font>',
			'rema': '<font color="blue">官网</font>',
			'urls': 'https://jiexi.de/',
			'tips': '<span class="layui-badge layui-bg-red">吐血推荐</span>',
			'tip1': '<font color="blue">橙子解析（二次解析）</font>',
			'url1': 'https://vip.czdz.xyz',
			'tip2': '<font color="red">解析地(官方直采)</font>',
			'url2': 'https://cms.jiexi.de',
			'tip3': '广告位招租',
			'url3': 'http://jiexi.de',
			'tip4': '广告位招租',
			'url4': 'http://jiexi.de'
			...
			'name': '采集常见问题',
			'rema': '无法播放等问题',
			'urls': 'http://jiexi.de/cjwt/',
			'tips': '<span class="layui-badge layui-bg-green">常见问题</span>',
			'tip1': '<font color="red">采集无法绑定分类的解决办法</font>',
			'url1': 'http://jiexi.de/cjwt/5.html',
			'tip2': '<font color="red">V10定时任务自动采集教程</font>',
			'url2': 'http://jiexi.de/cjwt/4.html',
			'tip3': '采集后没有播放数据的解决办法',
			'url3': 'http://jiexi.de/cjwt/6.html',
			'tip4': '采集后无法播放的解决办法',
			'url4': 'http://jiexi.de/cjwt/8.html'
		}]
	},
     ...
     'bizh': {
        ...
        'rows': [ {
            'name': '解析地',
            'rema': '官方平台直采',
            'apis': 'http://cms.jiexi.de/api.php/provide/vod/?ac=list',
            'tips': '<span class="layui-badge layui-bg-red">吐血推荐</span>',
            
        },{
            'name': '天堂资源',
            'rema': '官方平台直采',
            'apis': 'http://vipmv.cc/api.php/provide/vod/?ac=list ',
            'tips': '<span class="layui-badge layui-bg-green">强烈推荐</span>',
            
        },{
            'name': '清风资源',
            'rema': '360平台采集',
            'apis': 'https://www.qinghuanzy.com/api.php/provide/vod/',
        ...
        'rows': [{
            ...
            'name': '腾讯视频',
            'rema': '解析地',
            'apis': 'http://cms.jiexi.de/api.php/provide/vod/from/qq/',
            ...
            'name': '优酷视频',
            'rema': '解析地',
            'apis': 'http://cms.jiexi.de/api.php/provide/vod/from/youku/',
            'tips': '<span class="layui-badge layui-bg-green">国内节点</span>',
            ...
            'name': '奇艺视频',
            'rema': '解析地',
            'apis': 'http://cms.jiexi.de/api.php/provide/vod/from/qiyi/',
            'tips': '<span class="layui-badge layui-bg-green">国内节点</span>',
            ...
            'name': '芒果视频',
            'rema': '解析地',
            'apis': 'http://cms.jiexi.de/api.php/provide/vod/from/mgtv/',
            'tips': '<span class="layui-badge layui-bg-green">国内节点</span>',
            ...
            'name': '哔哩哔哩',
            'rema': '解析地',
            'apis': 'http://cms.jiexi.de/api.php/provide/vod/from/bilibili/',
            'tips': '<span class="layui-badge layui-bg-green">国内节点</span>',
            ...
            'name': '搜狐视频',
            'rema': '解析地',
            'apis': 'http://cms.jiexi.de/api.php/provide/vod/from/sohu/',
            'tips': '<span class="layui-badge layui-bg-green">国内节点</span>',
            ...
            'name': '乐视视频',
            'rema': '解析地',
            'apis': 'http://cms.jiexi.de/api.php/provide/vod/from/letv/',
            'tips': '<span class="layui-badge layui-bg-green">国内节点</span>',
            ...
            'name': 'PPTV',
            'rema': '解析地',
            'apis': 'http://cms.jiexi.de/api.php/provide/vod/from/pptv/',
            'tips': '<span class="layui-badge layui-bg-green">国内节点</span>',
